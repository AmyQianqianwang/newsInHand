...
public class Science extends Activity {
	...
	private final static String ALBUM_PATH = Environment
			.getExternalStorageDirectory() + "/news_image/" + "science/";
	Bitmap bitmap;
	...
	private Handler mHandler_initiate = new Handler() {
		public void handleMessage(Message msg) {
			...
			SimpleAdapter listItemAdapter = new SimpleAdapter(
					Science.this, listItem,// 数据源
					R.layout.science_item,// ListItem的XML实现
					// 动态数组与ImageItem对应的子项
					new String[] { "ItemImage", "ItemTitle", "ItemText" },
					// ImageItem的XML文件里面的一个ImageView,两个TextView ID
					new int[] { R.id.science_image, R.id.science_title,
							R.id.science_digest });
	...
	private Handler handler = new Handler(new Callback() {
		...
		public boolean handleMessage(Message msg) {
			...
			Toast.makeText(Science.this, obj, Toast.LENGTH_SHORT)
					.show();
			return false;
		}
	});
	...
	protected void onCreate(Bundle pSavedInstanceState) {
		...
		mListView = (Refresh) findViewById(R.id.science_list);
		listItem = new ArrayList<HashMap<String, Object>>();
		List<News> db_data = new ArrayList<News>();
		DB news_db = new DB(Science.this);
			...
			if (Yaowen.First_show) {
				new Thread(new Runnable() {
					...
					public void run() {
						...
						System.out.println("science news:");
						...
						DB db_insert = new DB(Science.this);
						db_insert.insert(mList);
						mList.clear();
						DB news_check = new DB(Science.this);
				...
				new Thread(new Runnable() {
					...
					public void run() {
						...
						if (Main.isNetworkAvailable) {
							...
							Data.putString("news_sort", "科技");
							Intent intent = new Intent(Science.this,
									Webview.class);
