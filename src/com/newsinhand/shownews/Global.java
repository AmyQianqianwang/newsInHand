...
public class Global extends Activity {
	...
	private final static String ALBUM_PATH = Environment
			.getExternalStorageDirectory() + "/news_image/" + "global/";
	...
	private Handler handler = new Handler(new Callback() {
		...
		public boolean handleMessage(Message msg) {
			...
			Toast.makeText(Global.this, obj, Toast.LENGTH_SHORT).show();
			return false;
		}
	});
	private Handler mHandler_initiate = new Handler() {
		public void handleMessage(Message msg) {
			...
			for (int i = 0; i < 10; i++) {
				...
				System.out.println("国际" + ns.getId());
			...
			SimpleAdapter listItemAdapter = new SimpleAdapter(
					Global.this, listItem,// 数据源
					R.layout.global_item,// ListItem的XML实现
					// 动态数组与ImageItem对应的子项
					new String[] { "ItemImage", "ItemTitle", "ItemText" },
					// ImageItem的XML文件里面的一个ImageView,两个TextView ID
					new int[] { R.id.global_image , R.id.global_title,
							R.id.global_digest });
	...
	protected void onCreate(Bundle pSavedInstanceState) {
		...
		mListView = (Refresh) findViewById(R.id.global_list);
		listItem = new ArrayList<HashMap<String, Object>>();
		List<News> db_data = new ArrayList<News>();
		DB news_db = new DB(Global.this);
				...
				new Thread(new Runnable() {
					...
					public void run() {
						try {
							...
							DB db_insert = new DB(Global.this);
							db_insert.insert(mList);
							mList.clear();
							DB news_check = new DB(Global.this);
				...
				new Thread(new Runnable() {
					...
					public void run() {
						...
						if (Main.isNetworkAvailable) {
							...
							Data.putString("news_sort", "国际");
							Intent intent = new Intent(Global.this,
									Webview.class);
