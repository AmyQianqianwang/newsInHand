...
public class Finance extends Activity {
	...
	private final static String ALBUM_PATH = Environment
			.getExternalStorageDirectory() + "/news_image/" + "finance/";
	Bitmap bitmap;
	...
	private Handler mHandler_initiate = new Handler() {
		public void handleMessage(Message msg) {
			...
			SimpleAdapter listItemAdapter = new SimpleAdapter(
					Finance.this, listItem,// 数据源
					R.layout.finance_item,// ListItem的XML实现
					// 动态数组与ImageItem对应的子项
					new String[] { "ItemImage", "ItemTitle", "ItemText" },
					// ImageItem的XML文件里面的一个ImageView,两个TextView ID
					new int[] { R.id.finance_image, R.id.finance_title,
							R.id.finance_digest });
	...
	private Handler handler = new Handler(new Callback() {
		...
		public boolean handleMessage(Message msg) {
			...
			Toast.makeText(Finance.this, obj, Toast.LENGTH_SHORT)
					.show();
			return false;
		}
	});
	...
	protected void onCreate(Bundle pSavedInstanceState) {
		...
		mListView = (Refresh) findViewById(R.id.finance_list);
		listItem = new ArrayList<HashMap<String, Object>>();
		List<News> db_data = new ArrayList<News>();
		DB news_db = new DB(Finance.this);
			...
			if (Yaowen.First_show) {
				new Thread(new Runnable() {
					...
					public void run() {
						...
						DB db_insert = new DB(Finance.this);
						db_insert.insert(mList);
						mList.clear();
						DB news_check = new DB(Finance.this);
				...
				new Thread(new Runnable() {
					...
					public void run() {
						...
						if (Main.isNetworkAvailable) {
							...
							Data.putString("news_sort", "财经");
							Intent intent = new Intent(Finance.this,
									Webview.class);
							...
							try {
								...
								if (httpResponse.getStatusLine()
									...
									String result = EntityUtils
											.toString(httpResponse.getEntity());
									String result_1 = result.substring(73);
									System.out.println("finance lei json1 " + result);
									System.out.println("finance lei json2 " + result_1);
