...
public class Joy extends Activity {
	...
	private final static String ALBUM_PATH = Environment
			.getExternalStorageDirectory() + "/news_image/" + "joy/";
	Bitmap bitmap;
	...
	private Handler mHandler_initiate = new Handler() {
		public void handleMessage(Message msg) {
			...
			SimpleAdapter listItemAdapter = new SimpleAdapter(
					Joy.this, listItem,// 数据源
					R.layout.joy_item,// ListItem的XML实现
					// 动态数组与ImageItem对应的子项
					new String[] { "ItemImage", "ItemTitle", "ItemText" },
					// ImageItem的XML文件里面的一个ImageView,两个TextView ID
					new int[] { R.id.joy_image,
							R.id.joy_title, R.id.joy_digest });
	...
	private Handler handler = new Handler(new Callback() {
		...
		public boolean handleMessage(Message msg) {
			...
			Toast.makeText(Joy.this, obj, Toast.LENGTH_SHORT)
					.show();
			return false;
		}
	});
	...
	protected void onCreate(Bundle pSavedInstanceState) {
		...
		setContentView(R.layout.joy);

		mListView = (Refresh) findViewById(R.id.joy_list);
		listItem = new ArrayList<HashMap<String, Object>>();
		List<News> db_data = new ArrayList<News>();
		DB news_db = new DB(Joy.this);
			...
			if (Yaowen.First_show) {
				new Thread(new Runnable() {
					...
					public void run() {
						...
						DB db_insert = new DB(Joy.this);
						db_insert.insert(mList);
						mList.clear();
						DB news_check = new DB(Joy.this);
						...
						public void run() {
							...
							try {
								...
								if (httpResponse.getStatusLine()
									...
									System.out.println("social " + json_result);
								}
